(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".filter-category__slider")) new swiper_core_Swiper(".filter-category__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
        ...
        if (document.querySelector(".benefits__slider")) new swiper_core_Swiper(".benefits__slider", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
        ...
        if (document.querySelector(".partners-cooperation__slider")) new swiper_core_Swiper(".partners-cooperation__slider", {
    ...
    const filterGoods = filterClass => {
        ...
        filterBox.forEach((item => {
            ...
            if (!item.classList.contains(filterClass) && filterClass !== "all") item.classList.add("hide");
        }));
    };
    ...
    for (let i = 0; i < block.length; i++) block[i].onclick = function() {
        this.classList.toggle("active");
    };
    let addToBasket = document.getElementsByClassName("button__basket");
    for (let i = 0; i < addToBasket.length; i++) addToBasket[i].onclick = function() {
        this.classList.toggle("active");
    };
    let addSocial = document.getElementsByClassName("contact-social__button");
    for (let i = 0; i < addSocial.length; i++) addSocial[i].onclick = function() {
        this.classList.toggle("active");
    };
    let deliveryMetod = document.getElementsByClassName("shipping-checkout__item-list");
    for (let i = 0; i < deliveryMetod.length; i++) deliveryMetod[i].onclick = function() {
        this.classList.toggle("active");
    };
    const btnsSide = document.querySelector(".side-buttons");
    function addActiveClass() {
        if (window.scrollY >= 200) btnsSide.classList.add("active"); else btnsSide.classList.remove("active");
    }
