  ...
  echo $value->name;
			...
			<div class="product-card__content">
				<div class="product-card__top-line">
					...
					<span class="sku_wrapper product-card__article">Артикул: <span>
							<?php echo ( $sku = $product->get_sku() ) ? $sku : 'N/A'; ?>
						</span></span>
...
<!-- 					<div data-quantity class="quantity product-card__quantity">
				...
				<div class="product-card__features features-product-card">
					<img src="<?php echo get_template_directory_uri() ?>/assets/img/product-card/features-back.svg" alt=""
						class="features-product-card__back-icon">
					...
					<div class="product-item">
						...
						<div class="product-item__media">
							<a href="./product-card.html" class="product-item__link">
								<img class="product-item__img whinset"
									src="<?php echo get_template_directory_uri() ?>/assets/img/products/pillow.jpg" alt="Image">
							</a>
				...
				<div class="filter-category__slide swiper-slide blanket">
					<div class="product-item">
						...
						<div class="product-item__media">
							<a href="./product-card.html" class="product-item__link">
								<img class="product-item__img whinset"
									src="<?php echo get_template_directory_uri() ?>/assets/img/products/pillow02.jpg" alt="Image">
							</a>
							<div class="product-item__top-line">
								<h4 class="product-item__label">Бестселлер</h4>
								<span class="product-item__discount">-20%</span>
				...
				<div class="filter-category__slide swiper-slide pillow">
					<div class="product-item">
						...
						<div class="product-item__media">
							<a href="./product-card.html" class="product-item__link">
								<img class="product-item__img whinset"
									src="<?php echo get_template_directory_uri() ?>/assets/img/products/pillow03.jpg" alt="Image">
							</a>
							<div class="product-item__top-line">
								<h4 class="product-item__label">Бестселлер</h4>
								<span class="product-item__discount">-20%</span>
				...
				<div class="filter-category__slide swiper-slide linen">
					<div class="product-item">
						...
						<div class="product-item__media">
							<a href="./product-card.html" class="product-item__link">
								<img class="product-item__img whinset"
									src="<?php echo get_template_directory_uri() ?>/assets/img/products/pillow04.jpg" alt="Image">
							</a>
							<div class="product-item__top-line">
								<h4 class="product-item__label">Бестселлер</h4>
								<span class="product-item__discount">-20%</span>
